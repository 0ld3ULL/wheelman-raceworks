...
const whyClark = [
  ...
  },
  {
    ...
    desc: "Clark Freeport Zone is built on the former US Air Force base. The roads are wide, well-maintained, and laid out with American-style planning — spacious, clean, and easy to navigate. It's one of the safest and most organised areas in the Philippines, with 24/7 security throughout the zone. When the sun goes down, Clark has 6+ casinos including the Las Vegas-style Hann Casino Resort, and neighbouring Angeles City has a lively restaurant and entertainment scene.",
  ...
  },
  {
    ...
    desc: "Want a rest day off the track? Subic Bay is just an hour away — world-class deep sea fishing, yacht charters, and stunning coastline. We can organise a fishing day for you and the crew. Catch tuna, mahi-mahi, and marlin, then eat your catch for dinner. Or stay local — hit the casinos, grab dinner out, or just relax by the pool. Your days off are as good as your track days.",
